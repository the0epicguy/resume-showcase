...
const RESUME_URL =
  "https://drive.google.com/file/d/1wx59B3pra-Jxu4qF7Tcl9LMZP41DESpJ/view?usp=sharing";
  ...
  return (
    ...
    >
      <div className="flex justify-center pt-6">
        <div className="flex items-center justify-center gap-2 rounded-full glass px-4 py-3 shadow-md">
          {navItems.map((item) => {
            const isActive =
              item.href === "/"
                ? location.pathname === "/"
