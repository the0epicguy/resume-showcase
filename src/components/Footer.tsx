...
export function Footer() {
  return <footer className="py-20 relative overflow-hidden">
      <div className="container mx-auto px-6 lg:px-12">
        ...
        duration: 0.6
          ...
          <div className="mt-6 flex items-center justify-center gap-4 flex-wrap">
            ...
            <Link to="/contact" className="px-6 py-3 rounded-lg glass text-sm font-medium hover:bg-muted/20 transition-colors flex items-center gap-2">
      ...
      {/* Ambient glow */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-[200px] rounded-full opacity-20 blur-3xl pointer-events-none" style={{
